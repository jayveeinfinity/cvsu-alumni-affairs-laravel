                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="w-100 d-flex flex-row-reverse" style="gap: 1rem;">
                            <button class="btn btn-outline-success" data-toggle="modal" data-target="#addAlumniForm" data-backdrop="static" data-keyboard="false" ><i class="fas fa-plus"></i> Add job posting</button>
                                        ...
                                        <tbody>
                                            @forelse ($jobPostings as $jobPosting)
                                                <tr>
                                                    ...
                                                    <td><span class="badge rounded-pill badge-primary">{{ $jobPosting->company }}</span></td>
                                                    <td>{{ $jobPosting->title }}</td>
                                                    <td>{{ $jobPosting->job_type }}</td>
                                                    <td>{{ $jobPosting->experience }}</td>
